...
"project_status_detail": {
    ...
    # ====================================================
    # HANDLER -> SERVICE SEARCH PARAMETERS
    #
    ...
    #
    # IMPORTANT:
    # project_level MUST NOT be here.
    # ====================================================
    ...
    #
    # Repository source uses:
    #
    # cursor_key =
    #     f"{last_item.get('project_level')}_"
    #     f"{last_item.get('period')}"
    #
    # ====================================================
    "repo_cursor_fields": [
        "project_level",
    ...
    "handler_key_route": "/v1/projects/status-detail/P-1001",
